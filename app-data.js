...
help: {
  main: {
    title: 'איך להשתמש?',
    content: "**FouFou** עוזר לך לגלות מקומות מעניינים ולתכנן מסלול טיול.\n\n**איך מתחילים:**\n1. בחר אזור (או \"הכל\", או GPS לקרוב אליך) ותחומי עניין, ולחץ \"המשך\"\n2. המערכת מחפשת מקומות ומציגה תוצאות\n3. לחץ \"צא לדרך עם גוגל\" לניווט מיידי, או \"מצב ידני\" לשליטה מלאה\n4. במצב ידני: דלג על מקומות (⏸️), פתח \"🗺️ מפה ותכנון\" לשינוי סדר ונקודת התחלה\n\n**תפריט (☰) למעלה:**\nמועדפים, מסלולים שמורים, תחומי עניין, הגדרות\n\n**רוצה עוד מקומות?**\n• **\"+ עוד\"** ליד כל קטגוריה — מביא מקומות נוספים מגוגל\n• **\"➕ הוסף ידנית\"** — חפש מקום לפי שם והוסף למסלול\n\n**טיפ:** לחץ על שם מקום כדי לפתוח אותו בגוגל מפות"
  },
  placesListing: {
    title: 'רשימת המקומות',
    content: "**איך המקומות נבחרים?**\nקודם מופיעים מקומות מועדפים (שהוספת דרך ⭐), ואחר כך מקומות מגוגל לפי דירוג.\n\n**כפתורים ליד כל מקום:**\n• ⏸️ — דלג על מקום (לא ייכלל במסלול). לחץ ▶️ כדי להחזיר\n• ⭐ — הוסף למועדפים (מקומות גוגל) או דרג (מועדפים)\n• 🖼️ — צפה בתמונה (אם קיימת)\n\n**רוצה עוד מקומות?**\n• **\"+ עוד\"** ליד כל קטגוריה — מביא מקומות נוספים מגוגל\n• **\"➕ הוסף ידנית\"** — חפש מקום לפי שם והוסף למסלול\n\n**לחיצה על שם המקום** פותחת אותו בגוגל מפות.\n\n**🗺️ מפה ותכנון:**\nפותח מפה עם מסלול הליכה אמיתי על כבישים.\nלחץ על נקודה כדי להשבית, להפעיל, או לקבוע כנקודת התחלה.\nבחר לינארי (מנקודה לנקודה) או מעגלי (חוזר להתחלה)."
  },
  route: {
    title: 'תוצאות המסלול',
...
help: {
  main: {
    title: 'How to use?',
    content: "**FouFou** helps you discover interesting places and plan a trip route.\n\n**Getting started:**\n1. Choose an area (or \"All\", or GPS for nearby) and interests, then click \"Continue\"\n2. The system finds places and shows results\n3. Click \"Go with Google Maps\" for immediate navigation, or \"Manual mode\" for full control\n4. In manual mode: skip places (⏸️), open \"🗺️ Map & Plan\" to change order and starting point\n\n**Menu (☰) at top:**\nFavorites, saved routes, interests, settings\n\n**Want more places?**\n• **\"+ more\"** next to each category — fetches more places from Google\n• **\"➕ Add manually\"** — search for a place by name and add to route\n\n**Tip:** Click on a place name to open it in Google Maps"
  },
  placesListing: {
    title: 'Places list',
    content: "**How are places chosen?**\nFavorite places (added via ⭐) appear first, then Google places by rating.\n\n**Buttons next to each place:**\n• ⏸️ — Skip place (won't be included in route). Press ▶️ to restore\n• ⭐ — Add to favorites (Google places) or rate (favorites)\n• 🖼️ — View photo (if available)\n\n**Want more places?**\n• **\"+ more\"** next to each category — fetches more Google places\n• **\"➕ Add manually\"** — search by name and add directly to route\n\n**Clicking the place name** opens it in Google Maps.\n\n**🗺️ Map & Plan:**\nOpens a map with real walking route on streets.\nClick a stop to disable, enable, or set as starting point.\nChoose linear (point to point) or circular (returns to start)."
  },
  route: {
    title: 'Route results',
